...
class EnemyDetectorServer:
    def start_enemy_detection_model():
        ...
        while True:
            ...
            img = grab_screen(region=(0, 40, 1920, 1080)) #TODO: decide on region
            x0 = RADAR_RANGE[0]
            y0 = RADAR_RANGE[1]
            x1 = RADAR_RANGE[2]
            y1 = RADAR_RANGE[3]
            ...
            if enemy_on_radar:
                ...
                if enemy_coords_on_screen is not None:
                    data = {"enemy_on_screen" : "1", "enemy_screen_coords" : enemy_coords_on_screen}
                else:
