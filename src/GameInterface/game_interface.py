...
class GameServer:
    ...
    def get_action(self):
        ...
        s.send("done".encode('utf-8'), self.server)
    ...
    def configure_game():
        ...
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'play_distance', f'{play_sound_distance}') #dont show sound
        ...
        # bots
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'bot_goto_selected', '0') #navigation
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'bot_goto_mark', '0') #navigation
        ...
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'notarget') # bot ignores player
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'mp_random_spawn', '3') # random spawn for enemy bot, not agent
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'mp_random_spawn_los', '1') # random spawn for enemy bot to ensure that enemy bot not in sight of agent
        # CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'bot_max_vision_distance_override', '1', '30') # random spawn for enemy bot, not agent
    ...
    def start_game(self, bombsite_choice):
        ...
        CSGO_Env_Utils.csgo_type_command(self.keyboard_controller, 'bot_place')
